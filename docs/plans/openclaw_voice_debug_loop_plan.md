...
승인 완료 후 dispatcher로 보내는 payload는 현재 구현과 동일하게 base64url JSON만 사용한다.
...
3. browse-read: open/snapshot/screenshot
4. browse-interact: click/type/fill/select
5. browser-high-impact: upload/download/submit/send/payment은 별도 승인 또는 deny
```
