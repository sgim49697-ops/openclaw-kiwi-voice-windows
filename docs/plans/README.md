...
| `openclaw_voice_wrapper_plan.md` | 중앙 dispatcher, Windows Node 정책, Browser/Codex/Kiwi 실행 경계 상세 계획 |
| `openclaw_voice_debug_loop_plan.md` | 자동 디버그 agent와 외부 승인 큐 기반 검증 루프 |
| `kiwi_voice_windows_v7_1_setup.md` | Windows Kiwi Voice 설치 gate와 dry-run bridge 절차 |
